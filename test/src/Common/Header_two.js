  ...
  return (
	...
	{/* <!-- START --> */}
		...
		<div class="str">
				...
				<div class={` ${scrolling ? 'hom-top dmact' : 'hom-top_two'}`}>
					...
					<div class="container">
						<div class="row">
							...
							{/* 	<!--MOBILE MENU-->
								...
								<div className={isClicked ? 'menu ani' : 'menu'} onClick={nav}>
									<h4>All Category</h4>
									
								</div>
							
							
							<div className={isClicked ? 'pop-menu ani' : 'pop-menu'} onClick={nav}>
									<div class="container">
										<div class="row"> <i class="material-icons clopme">close</i>
											<div class="pmenu-spri">
												<ul>
													<li>
													<Link to="/service"><img src="images/icon/shop.png"/>All Service</Link>
													</li>
													<li>
													...
													<li>
													<Link to="/Coupen"><img src="images/icon/coupons.png"/>Coupon & deals</Link>
													</li>
													<li>
